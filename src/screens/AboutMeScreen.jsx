    ...
    <section className="min-vh-100">
      ...
      <Container fluid="sm" className="text-center">
        ...
        <p>
          ...
          Lisboa, Portugal. Mi pasión por el desarrollo web comenzó en mayo del
          2020 cuando comencé a construir los retos propuestos en{" "}
          <a
        ...
        <p>
          ...
          conocimiento en este campo. En octubre de 2020, sentí la necesidad de
          profundizar en el desarrollo web, lo que me llevó a aprender js y
          luego reactjs junto con otras tecnologías de diseño. Con cada proyecto, me esfuerzo por crear una solución
          única y efectiva al tiempo que integro las últimas tecnologías web.
        </p>
        <p>
